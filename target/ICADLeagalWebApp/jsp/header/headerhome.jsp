...
<div class="w3l-main " id="borderStyle">
	<h1 class="w3l-title">
		<span class="logo"><img src="../images/telangana.png">
			<span class="logo-text logo-color">TG Irrigation Management Information
				System</span>
		...
		<div class=" show-grid">
		 <div class="col-md-12">
			 <h4 style="color: blue; margin: 1em; font-weight: bold;">Logins: 1.&emsp; Ayacut/TMS / Form20: &emsp; Use HRMS logins.<br>
			                                                         &emsp;&emsp;&emsp;&emsp;2.&emsp;IR Paras:&emsp; <a style="color: red" href="../web/home" id="gotohome"><strong><U>1.Home</U></strong></a> &emsp;&emsp;
			                                                         <a style="color: red" href="javascript:void(0)" id="forgotlogin"><strong><U>2.Email request</U></strong></a> &emsp;&emsp; <br>
			                                                         
			                                                       
			                                                        
				</h4>
				<h4 style="color: black;">  Note: please use show password to avoid  login attempt fail.</h4> 
		</div> 
							...
							<li>
								<div class="w3layouts-banner-top">
									<div class="agileits-banner-info">
										...
										<p>TG Irrigation Management Information System</p>
	...
	$('#myemail').click(function(){
	 ...
	 $('#userLogin').parsley().on('field:validated', function() {
		  ...
		  .on('form:submit', function() {
			  ...
			  var keyBase64 ="o9szYIOq1rRMiouNhNvaq9";
