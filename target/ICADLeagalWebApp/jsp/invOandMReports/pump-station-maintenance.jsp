	...
	<div>
		...
		<div class="panel panel-primary" style="padding: 10px">
			<div class="panel-heading">
				<h3 class="panel-title">O&M of Lift Maintenance:Lift Maintenance Report</h3>
			</div>
						...
						<table class=" display table-bordered" style="width: 100%"
							...
							<thead>
								...
								<tr style="font-size: 18px">
									...
									<th >Pump Station</th>
									<th >Designation</th>
									<c:if test="${pumpdaily!=null}">
									<th >Inspect Date</th>
									<th >Inspect Hour</th>
									
									</c:if>
									 <c:if test="${pumpweekly!=null}">
							...
							<tbody>
								...
								<c:forEach items="${pumpdaily}" var="t" varStatus="count">
									...
									<tr style="font-size: 16px">
										...
										<td><b><c:out value="${t.unitName}"></c:out></b></td>
											<td><b><c:out value="${t.pumpLink}"></c:out></b></td>
											<td><b><c:out value="${t.pumpStation}"></c:out></b></td>
											<td><b><c:out value="${t.designationName}"></c:out></b></td>
											<td><b><c:out value="${t.inspectDate}"></c:out></b></td>
											<td><b><c:out value="${t.inspectHour}"></c:out></b></td>
											<td><a 	href="javascript:void(null);" onclick="getResInfo1('${t.pumpStationId}','${t.inspectDate}','${t.inspectHour}','${t.unitId}','${t.dutyFrequencyId}');"><b><c:out value="${t.dailyCount}"></c:out></b></a></td>
									...
									<%-- 	<td><a 	href="javascript:void(null);" onclick="getResInfo('${t.resCode}','${t.year}','${t.unitId}');"><c:out value="${t.resInspectCount}"></c:out></a></td> --%>
									 ...
									 <c:forEach items="${pumpweekly}" var="t" varStatus="count">
									<a target="_blank"  href="../parasreport/cagParasAbstractOffice?unitId=<c:out value="${t.unitId}"></c:out>" ></a>
									<tr style="font-size: 16px">
										...
										<td><b><c:out value="${t.unitName}"></c:out></b></td>
											...
											<td><a 	href="javascript:void(null);" onclick="getResInfo2('${t.pumpStationId}','${t.weekstartDate}','${t.weekendDate}','${t.unitId}','${t.dutyFrequencyId}');"><b><c:out value="${t.weeklycount}"></c:out></b></a></td>
...
<!-- //container-content -->
	...
	<div id="dialog-para" title="Pump Maintenance Report" style="display:none">
...
<script type="text/javascript">
function getResInfo1(pumpstationId,inspectdate,inspecthour,unitId,dutyfreqId){
	
	
$.ajax({
    type: "GET", //rest Type
    dataType: 'json', //mispelled
    url: "../invReport/pump-main-Info?pumpStationId="+pumpstationId+"&inspectDate="+inspectdate+"&unitId="+unitId+"&inspectHour="+inspecthour+"&dutyFrequencyId="+dutyfreqId,
    async: false,
    contentType: "application/json; charset=utf-8",
    success: function (msg) {
        console.log(msg); 
    	 $('#dialog-para1').empty();
         $('#dialog-para1').append( '<div class="col-md-12 invDiv"><h3>Pump Maintenance Info</h3>  </div>');            
         ...
         $("#dialog-para1").append('<div  class="col-md-3 " style="font-weight:bold;" >  PumpStation Name </div> <div  class="col-md-3 " style="font-weight:bold;" > : '+msg[0].pumpStation +'</div>'); 
...
$.ajax({
    type: "GET", //rest Type
    dataType: 'json', //mispelled
    url: "../invReport/pump-inpsect-info?pumpStationId="+pumpstationId+"&inspectDate="+inspectdate+"&unitId="+unitId+"&inspectHour="+inspecthour+"&dutyFrequencyId="+dutyfreqId,
    async: false,
    contentType: "application/json; charset=utf-8",
 ...
 */
 ...
 $("#gen").append('<div  class="row col-md-12 invDiv" style="font-weight:bold;color:blue" > <div  class="col-md-2 " style="font-weight:bold;" >Inspection Name</div><div  class="col-md-2 " style="font-weight:bold;" >Designation</div><div  class="col-md-2 " style="font-weight:bold;" >InspecttionDate/Hour</div><div  class="col-md-2 " style="font-weight:bold;" >  Remarks</div> <div  class="col-md-2 " style="font-weight:bold;" >Status</div></div>');
 for(i in  msg2 ){
	 var j=parseInt(i)+1; 
 	
	 
         $("#gen").append('<div  class="row col-md-12" > <div  class="col-md-2 invDiv" style="font-weight:bold;" > '+msg2[i].pmActivity+' </div> <div  class="col-md-2 " style="font-weight:bold;" >  '+msg2[i].designationName+'</div><div  class="col-md-2 " style="font-weight:bold;" >  '+msg2[i].inspectDate+' / '+msg2[i].inspectHour+'</div>   <div  class="col-md-2 " style="font-weight:bold;" >  '+msg2[i].remarks+'</div><div  class="col-md-2 " style="font-weight:bold;" >  '+msg2[i].approveStatus+'</div></div>'); 
...
function getResInfo2(pumpstationId,weekstartdate,weekenddate,unitId,dutyfreqId){
	
	
	$.ajax({
	    type: "GET", //rest Type
	    dataType: 'json', //mispelled
	    url: "../invReport/pump-main-Info?pumpStationId="+pumpstationId+"&weekstartDate="+weekstartdate+"&unitId="+unitId+"&weekendDate="+weekenddate+"&dutyFrequencyId="+dutyfreqId,
	    async: false,
	    contentType: "application/json; charset=utf-8",
	    success: function (msg) {
	        console.log(msg); 
	...
	$.ajax({
	    type: "GET", //rest Type
	    dataType: 'json', //mispelled
	    url: "../invReport/pump-inpsect-info?pumpStationId="+pumpstationId+"&weekstartDate="+weekstartdate+"&unitId="+unitId+"&weekendDate="+weekenddate+"&dutyFrequencyId="+dutyfreqId,
	    async: false,
	    contentType: "application/json; charset=utf-8",
	    success: function (msg2) {
	      //  console.log(msg2); 
