						...
						<div class="table-responsive" id="printarea">
							...
							<table class=" display table-bordered " style="width:100%" id="table1">
								...
								<tr style="font-size: 11px">	<td style="text-align: center;"><b><c:out
										...
										<c:when test="${t.deficiencyCategory==-1}">
										
										<td style="color: red"> To download reports please enter inspection details of Dam.  </td>
										
										</c:when>
										
										<c:when test="${t.deficiencyCategory==4}">
									...
									<tr  style="font-size: 11px">	
										...
										<tr style="font-size: 11px"><td><b>Annexure-I</b></td>
										 <td>
										...
										<tr style="font-size: 11px"><td><b>General Details</b></td>
										<td>
										...
										<tr style="font-size: 11px"><td  ><b>Inspection Info</b></td>			
										<td>
										...
										<tr style="font-size: 11px"><td  ><b>Part 2a (Inspection checklist)</b></td><td>
										...
										<br></td></tr>
										<tr style="font-size: 11px"><td  ><b>Evaluation reports</b></td>
										...
										<td  ><b>Inspection Photographs / Documents </b></td>
