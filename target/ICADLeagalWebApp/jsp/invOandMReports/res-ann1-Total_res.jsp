  ...
  /* function getresabstractdata(year,dutyFrequencyId,formId,flag)
{
	...
	//alert("tanks uform abdata officeaccess" +officeaccess+"unit"+unit+"circle"+circle+"division"+division+"subdivision"+subdivision+"designation"+designation+"year"+year);
	 ...
	 //alert(cagGistId);
	 	...
	 	//var newyear =   $("#formyear1").val();
	 	
	 	//var dutyFrequencyId =   $("#uformdutyFrequencyId").val();
	 	
	 		
	 		
	 	
	 		//alert(" "+year+" "+formId+ " " +flag+"--"+newyear+"--"+uformdutyFrequencyId);
...
<!-- backbutton end -->
	...
	<input name=resinspectInfoId id="resinspectInfoId" value="NA" type=hidden>
	 ...
	 <br><br>
		...
		<button type="button" name="backtoreportinint" id="backtoreport1" class="btn btn-1 btn-primary center-block " onclick="getresabstractdata(${resYear},${resFrequency},'resann1report','true')"><b>Back to Initial Abstract Data</b></button>
						...
						<div class="table-responsive" id="printarea">
							...
							<table class=" display table-bordered " style="width:100%" id="table1">
								<thead >
									...
									<th  style="text-align: center;">NRLD Code</th>
									<th  style="text-align: center;">Unit</th>
									<th  style="text-align: center;">Circle</th>	
									
									<th  style="text-align: center;">Division</th>					
									
									<th  style="text-align: center;">Sub Division 
									</th>
								...
								<tr>	<td style="text-align: center;"><b><c:out
												value="${count.count}"></c:out></b></td>
												
										<td  style="text-align: center;color: blue; font-weight: bold;">
										
										   <b><c:out value="${t.resName}"></c:out></b> 
										
										</td>
										
											<td><b><c:out value="${t.nrldCode}"></c:out></b></td>
