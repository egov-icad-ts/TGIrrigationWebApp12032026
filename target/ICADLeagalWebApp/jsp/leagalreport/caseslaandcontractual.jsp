...
<div class="panel panel-primary ">
			<div class="panel-heading">
				<h3 class="panel-title">View Cases</h3>
			</div>
...
<form:form id="casesReport" method="post"
		...
		<c:if test="${caseList!=null }">
			<br></br>
		<!-- <div class='container'> -->
		<div class=" mainprint  pagecontent  toppad" style="display:block">
		 ...
		 <div class="table-responsive" id="printarea"  >
						<table class=" table-bordered " id="table">
							...
							<tbody>
								<c:forEach var="c" items="${caseList}" varStatus="count">
		...
		<div class="row show-grid">
					...
					<!--  <div id="pagination-here">Pagination goes here</div> -->
  <!--   <script>
        // init bootpag
