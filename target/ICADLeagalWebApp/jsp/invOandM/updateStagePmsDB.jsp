...
//alert("formId"+formId)
	...
	var act = "../invtsimis/resultofpmsstageliveDB";
	var formId = "#" + formId;
...
<div class="w3_agile_main_left">
		<div class="panel panel-primary ">
			<div class="panel-heading">
				<h3 class="panel-title">Database Access pmsStage</h3>
			</div>
				...
				<div class="row col-md-12 toppad ">
					...
					<div class="col-md-2">
							<input type="submit" class="btn btn-1 btn-primary center-block"
								id="submitquery" value="submit query"  onclick="getdata('querypane')">
						</div>
  ...
  <table class="tablenew display table-bordered " id="table3">
     <thead>
    <c:if test="${keys!=null}">     
        <tr>
         <c:forEach items="${keys}" var="list" varStatus="count">
          <th><c:out value="${list}"></c:out></th>
          </c:forEach>
