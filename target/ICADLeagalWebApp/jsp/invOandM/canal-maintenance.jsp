...
<div class="col-md-9">
	...
	<div class="panel panel-primary " >
		<div class="panel-heading">
			<h3 class="panel-title">O&M Of Canal:Maintenance of Canal</h3>
		</div>
...
<form:form id="mainformid" name="mainformname"
		...
		<div class="col-md-6">
					...
					<div class="col-md-6">
						...
						<div class="col-md-6">
							<label class="label-controlPMS rowlebel ">Select
								Canal Type: <font color=red>*</font>
							</label>
						</div>
						...
						<div class="col-md-6">
							<select class="form-control" id="canalTypeId" name="canalTypeId"
                             ...
                             <option value=" ">--select--</option>
								...
								<option value="2">Major/Branch</option>
								<option value="3">Distrributory</option>
								<option value="4">Minor</option>
								<option value="5">Sub Minor</option>
								<option value="6">F.C</option>
						...
						<div class="col-md-6">
							<select class="form-control" id="canalId" name="canalId"
								required>
                             <option value=" ">--select--</option>
								<option value="1">Canal1</option>
								<option value="2">Canal2</option>
								<option value="3">Canal3</option>
						...
						<div class="col-md-6">
							<label class="label-controlPMS rowlebel ">Select
								Reach: <font color=red>*</font>
							</label>
						</div>

						<div class="col-md-6">
							<select class="form-control" id="reachId" name="reachId"
								required>
                             <option value=" ">--select--</option>
								<option value="1">Reach1-1.5</option>
								<option value="2">Reach1.5-3</option>
								<option value="3">Reach3-4.5</option>
				  ...
				  />
					...
					<div class="col-md-12 invDiv">	  
					  ...
					  <div class="col-md-2">
					   ...
					   <label class="label-control rowlebel  " for="parameter1">Canal Water Surface Elevation (Ft.)</label>
						</div> 
						
					<div class="col-md-2">	 
					<input  	type="text" class="form-control " id="cwselevation" name="cwselevation" value=""	  /> 
					
					</div>
					
					 <div class="col-md-2">
					  
					   <label class="label-control rowlebel  " for="parameter1">Discharge (Cusecs)</label>
						</div>
					...
					<input  	type="text" class="form-control" id="cwselevation" name="cwselevation" value=""	  /> 
					   ...
					   <label class="label-control rowlebel  " for="parameter1">Full Supply Discharge at Head</label>
						</div> 
					<div class="col-md-2">	 
					<input  	type="text" class="form-control" id="cwselevation" name="cwselevation" value=""	  /> 
					...
					<div class="col-md-12 invDiv">	
					 ...
					 <div class="col-md-2">
					   ...
					   <label class="label-control rowlebel  " for="parameter1">Guage at Head</label>
						</div> 
					<div class="col-md-2">	 
					<input  	type="text" class="form-control" id="cwselevation" name="cwselevation" value=""	  /> 
					 ...
					 <div class="col-md-2">
					   ...
					   <label class="label-control rowlebel  " for="parameter1">Guage at Control structure(s) / Middle reach</label>
						</div> 
					<div class="col-md-2">	 
					<input  	type="text" class="form-control" id="cwselevation" name="cwselevation" value=""	  /> 
					   ...
					   <label class="label-control rowlebel  " for="parameter1">Guage at Tail end</label>
						</div> 
					<div class="col-md-2">	 
					<input  	type="text" class="form-control" id="cwselevation" name="cwselevation" value=""	  /> 
					...
					<div class="col-md-12 invDiv">	
					 <div class="col-md-2">
					   ...
					   <label class="label-control rowlebel  " for="parameter1">Discharge  at Head</label>
						</div> 
					<div class="col-md-2">	 
					<input  	type="text" class="form-control" id="cwselevation" name="cwselevation" value=""	  /> 
					...
					<div class="col-md-2">
					   ...
					   <label class="label-control rowlebel  " for="parameter1">Discharge at Control structure(s) /Middle reach</label>
						</div> 
					<div class="col-md-2">	 
					<input  	type="text" class="form-control" id="cwselevation" name="cwselevation" value=""	  /> 
					...
					<div class="col-md-2">
					   ...
					   <label class="label-control rowlebel  " for="parameter1">Discharge at Tail end</label>
						</div> 
					<div class="col-md-2">	 
					<input  	type="text" class="form-control" id="cwselevation" name="cwselevation" value=""	  /> 
					...
					<form:form id="weeklymaint" name="weeklymaintname"  modelAttribute="pumpactivityList" method="post" 	data-parsley-validate-if-empty="">
					 ...
					 <input name="pumpMaintActivityList[0].unitId" value="23"
					  ...
					  <div class="col-md-6">
					   ...
					   <label class="label-control rowlebel  " for="parameter1">Any Encroachment of land Observed?</label>
						</div> 
						
					<div class="col-md-6">	 
						
							
        <label class="radio-inline"> <input type="radio" class="myradio" name="actionreq" id="actionreq${kcount.count }"     value="false"   >NO</label>
        <label class="radio-inline"> <input type="radio" class="myradio" name="actionreq" id="actionreq${kcount.count}"     value="true"   >Yes</label>
				  ...
				  />
					...
					<div class="col-md-12 invDiv">	
					 ...
					 <div class="col-md-2">
					   ...
					   <label class="label-control rowlebel  " for="parameter1">District</label>
						</div>
					...
					<select class="form-control" id="districtId" name="districtId"
					   ...
					   <label class="label-control rowlebel  " for="parameter1">Mandal</label>
						</div> 
					<div class="col-md-2">	 
					<select class="form-control" id="mandalId" name="mandalId"
							onchange="getVillages(this.value)"  required></select> 
					
					</div>
					 <div class="col-md-2">
					  
					   <label class="label-control rowlebel  " for="parameter1">Village</label>
						</div> 
					<div class="col-md-2">	 
				...
				<div id="verticalmon">
				<ul>
					<li><a href="#animal" onclick="getcheckfalse1()">Animal Burrows</a></li>
					<li><a href="#chak" onclick="getcheckfalse2()">Chak Area</a></li>
				...
				<div id="animal">
				 ...
				 <input name="pumpMaintActivityList[0].unitId" value="23"
					...
					<div class="col-md-6">	 
					  ...
					  <label class="label-control rowlebel  " for="parameter1">Any Animal Burrows Observed?</label>		
        <label class="radio-inline"> <input type="radio" class="myradio" name="actionreq" id="actionreq${kcount.count }"     value="false"   >NO</label>
        <label class="radio-inline"> <input type="radio" class="myradio" name="actionreq" id="actionreq${kcount.count}"     value="true"   >Yes</label>
				...
				<div id="chak">
				 ...
				 <input name="pumpMaintActivityList[0].unitId" value="23"
					...
					<div class="col-md-6">	 
						   ...
						   <label class="label-control rowlebel  " for="parameter1">Chak Area</label>		
        <label class="radio-inline"> <input type="radio" class="myradio" name="actionreq" id="actionreq${kcount.count }"     value="false"   >NO</label>
        <label class="radio-inline"> <input type="radio" class="myradio" name="actionreq" id="actionreq${kcount.count}"     value="true"   >Yes</label>
				...
				<div class="col-md-12 invDiv">		
					...
					<div class="col-md-6">	 
					   ...
					   <label class="label-control rowlebel  " for="parameter1">Chak Location (Revenue Division)</label>
					<input  	type="text" class="form-control" id="cwselevation" name="cwselevation" value=""	  /> 
					...
					<div class="col-md-6">	 
					   ...
					   <label class="label-control rowlebel  " for="parameter1">Chak No.</label>
					<input  	type="text" class="form-control" id="cwselevation" name="cwselevation" value=""	  /> 
					...
					<div class="col-md-4">	 
					   ...
					   <label class="label-control rowlebel  " for="parameter1">Type of outlet</label>
					<input  	type="text" class="form-control" id="cwselevation" name="cwselevation" value=""	  /> 
					...
					<div class="col-md-4">	 
					   ...
					   <label class="label-control rowlebel  " for="parameter1">Size of out let</label>
					<input  	type="text" class="form-control" id="cwselevation" name="cwselevation" value=""	  /> 
					...
					<div class="col-md-4">	 
					   ...
					   <label class="label-control rowlebel  " for="parameter1">Design head at out let</label>
					<input  	type="text" class="form-control" id="cwselevation" name="cwselevation" value=""	  /> 
				...
				<div class="col-md-12 invDiv">		
					<div class="col-md-4">	 
					   ...
					   <label class="label-control rowlebel  " for="parameter1">Design discharge of the out let</label>
					<input  	type="text" class="form-control" id="cwselevation" name="cwselevation" value=""	  /> 
					...
					<div class="col-md-4">	 
					   ...
					   <label class="label-control rowlebel  " for="parameter1">Actual Discharge ( Carrying Capacity of water course)</label>
					<input  	type="text" class="form-control" id="cwselevation" name="cwselevation" value=""	  /> 
					...
					<div class="col-md-4">	 
					   ...
					   <label class="label-control rowlebel  " for="parameter1">Area irrigated in the Chak during the month</label>
					<input  	type="text" class="form-control" id="cwselevation" name="cwselevation" value=""	  /> 
					...
					<div class="col-md-4">	 
					   ...
					   <label class="label-control rowlebel  " for="parameter1">Quantity of water supplied (cusec*days)</label>
					<input  	type="text" class="form-control" id="cwselevation" name="cwselevation" value=""	  /> 
					...
					<div class="col-md-4">	 
					   ...
					   <label class="label-control rowlebel  " for="parameter1">Unauthorised  irrigated area (Acres)</label>
					<input  	type="text" class="form-control" id="cwselevation" name="cwselevation" value=""	  /> 
					...
					<div class="col-md-4">	 
					   ...
					   <label class="label-control rowlebel  " for="parameter1">Unauthorised Water use (cft)</label>
					<input  	type="text" class="form-control" id="cwselevation" name="cwselevation" value=""	  /> 
