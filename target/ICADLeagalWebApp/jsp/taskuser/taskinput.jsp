				...
				if(k!=null){
					...
					$.each(obj, function(key, value) {
						...
						if( k>0){
							...
							if(value.divisionId!=t){
								$('#divisionId').append( '<option value="'+value.divisionId+'" disabled="disabled" > '+value.divisionName+'</option>' );
							}
						}
						if( k==0){
					...
					$.each(obj, function(key, value) {
						...
						if(l>0){
							...
							if(value.subdivisionId!=t){
								...
								$('#subdivisionId').append( '<option value="'+value.subdivisionId+'"  disabled="disabled"> '+value.subdivisionName+'</option>' );
			...
			<div class="col-md-12">
				...
				<div class="alert alert-primary" role="alert">
					...
					<strong>Note: Please Select Unit office/ Circle Office to
						Assign the Task to Unit Office /Circle Office Staff </strong></div>
				...
				<div class="col-md-6">
							...
							<select class="form-control" id="unitId" name="unitId"
								...
								<c:forEach items="${unitList}" var="u">
									...
									<c:choose>
										...
										<c:otherwise>
											<option value="${u.unitId}" disabled="disabled">${u.unitName}</option>
										</c:otherwise>
									</c:choose>
					...
					<div class="col-md-6">
						<input type="text" class="form-control datepicker" id="targetDate"
							name="targetDate" placeholder="dd/mm/yyyy" required />
					</div>
				...
				<div class="col-md-12">
					...
					<div class="col-md-6">
						...
						<label class="label-control rowlebel ">Upload Multiple/Single File</label>
			...
			<div class="col-md-12">
			 <br></br>
				...
				<div class="col-md-2"></div>
					<label class="radio-inline"> <input class="ot" type="radio"  name="officeType" id="officeType1" checked="checked" value="1">	<strong>None</strong></label> 
					<label class="radio-inline" id="unitlable"> <input class="ot" type="radio" name="officeType" id="officeType2" value="2"> <strong>Unit Office</strong></label>
					
					<label class="radio-inline" id="circlelable"> <input class="ot" type="radio" name="officeType" id="officeType3" value="3"> <strong>Circle Office</strong></label>
				...
				<div class="col-md-6" id="sectionList">
					...
					<!-- <div class="row show-grid" id="sectionList"> -->
			...
			<div class="row show-grid">
				<div class="col-md-10 ">
					<label class="label-control rowlebel "></label><input type="submit"
						class="btn btn-1 btn-primary center-block" id="addtask"
						value="Add Task">
				</div>
			</div>
	 ...
	 $('#taskinput').parsley().on('field:validated', function() {
		  ...
		  .on('form:submit', function() {
			 // alert("coming here");
			  ...
			  document.forms.taskinput.action="../task/taskinput";
