...
<div>
	...
	<div class="panel panel-primary"    >
			<div class="panel-heading  ">
				<h3 class="panel-title">CE Wise Districts-Ayacut<c:if test="${userObj!=null}">	
								...
								<c:if test="${ayacutList!=null}">
									...
									<c:if test="${t.districtId!=-3 }">
										...
										<tr style="text-align: center;">
											...
											<td style="color: blue"><b><c:out value="${t.districtName}"></c:out></b> </td>	
										...
										<%-- 	<td  style="color:green" ><c:out value="${t.irriagtedAyacut}"></c:out> </td>	 --%>
											...
											<td  ><strong><c:out value="${t.projectName}"></c:out></strong> </td>		
