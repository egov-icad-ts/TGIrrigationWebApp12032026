...
<div>
	...
	<div class="panel panel-primary"    >
			<div class="panel-heading  ">
				<h3 class="panel-title">Project Wise Mandal and village -Ayacut<c:if test="${userObj!=null}">	
...
<div class="alert alert-info" role="alert">
				...
				<br>
				<strong style="color:#CA3F22"> Note2: 'NA' means not entered.</strong>
				<br>
									...
									<c:if test="${ t.mandalId!=-3 }">
										...
										<tr style="text-align: center;">
											...
											<td style="color: blue" ><c:out value="${t.projectName}"></c:out> </td>	
												...
												<td  style="color: maroon; " ><c:out value="${t.mandalName}"></c:out> </td>	
												<td  style="color: black; " ><c:out value="${t.villageName}"></c:out> </td>					
   ...
   $('#table1').DataTable( {
        ...
        buttons: [
            ...
            },
            {
                ...
                messageTop: 'Project-Mandal Ayacut Report',
                	 exportOptions: {
                         columns: ':visible'
                     }
            ...
            
            {
                ...
                title: 'Project-Mandal Ayacut Report',
