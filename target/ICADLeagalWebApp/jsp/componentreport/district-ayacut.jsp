...
<div>
	...
	<div class="panel panel-primary"    >
			<div class="panel-heading  ">
				<h3 class="panel-title">District Wise Projects-Ayacut<c:if test="${userObj!=null}">	
...
<div class="alert alert-info" role="alert">
				<strong style="color:#CA3F22"> Note: Please click on Exclude for Print/Export button  for exporting data without Package/Unit/Mandal/Constituency</strong>
				<br>
    ...
    $('#table1').DataTable( {
        ...
        buttons: [
                  ...
                  },
            {
                ...
                messageTop: 'District-Ayacut Report',
                exportOptions: {
                    columns: ':visible'
                }
