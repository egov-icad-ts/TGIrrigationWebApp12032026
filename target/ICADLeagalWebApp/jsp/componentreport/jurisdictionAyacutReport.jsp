...
<div class="alert alert-info" role="alert">
				...
				<br>
				<strong style="color:#CA3F22"> Note3: 'NA' under Circle Name and  'NA' Division Name means ayacut entered from CE login/SE login .</strong>
				<br>
						...
						<table class="display table-bordered " id="table1">
							...
							<tbody>
								...
								<c:if test="${ayacutList!=null}">
									...
									<c:if test="${t.circleId!=-3 && t.divisionId!=-2 }">
							...
							<c:if test="${t.circleId==-3 && t.divisionId==-3 }">
