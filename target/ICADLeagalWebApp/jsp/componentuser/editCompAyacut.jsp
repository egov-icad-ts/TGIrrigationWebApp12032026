	...
	function getVillages(mandal){
		...
		//alert(mandalId);
	      ...
	      success: function (response) {
			 ...
			 var sellectVill=$('#selectvillage').val();
             ...
             <!--  <div class="alert alert-info" role="alert">
               ...
               -->
				...
				<input type="hidden" class="form-control"  id="selectedConstId" name="selectedConstId" value="${selectedConstId}"/>
					...
					<div class="col-md-6">
						<div class="col-md-6">
							<label class="label-controlPMS rowlebel ">Unit*</label>
					...
					<%-- 	<div class="col-md-6">
						...
						<div class="col-md-6">
							<label class="label-controlPMS rowlebel ">Project*</label>
...
<!-- 
 ...
 -->
						...
						<div class="col-md-6">
							...
							<label class="label-control rowlebel ">Ayacut in Acres*</label>
						</div>

						<div class="col-md-5">

							<input type="text" class="form-control" id="presentAyacutCreated" 
								name="presentAyacutCreated" placeholder="in Acres" required  value="${selectAyacutAcres}"/>
						</div>
						

						<div class="col-md-6">

							<label class="label-control rowlebel ">Stabilized Ayacut
								in Acres</label>
						</div>

						<div class="col-md-5">

							<input type="text" class="form-control" id="stableAyacut"  
								name="stableAyacut" placeholder="in Acres" value="${ selectStableAcres}"/>
						</div>
