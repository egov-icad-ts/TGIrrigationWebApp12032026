...
function getMandals(){
	...
	/* function loadaddresform(){
		
		alert("kal is here")
		
		  $('#res').attr('action', "../web/addRes");
          $("#res").submit();
	...
	<div class="page">
		...
		<div class="panel panel-primary ">
			<div class="panel-heading">
				<h3 class="panel-title">Add Respondent</h3>
			</div>
<form:form id="res" method="post" modelAttribute="respondent" data-parsley-validate-if-empty="" >
						...
						<div class="col-md-3"></div>
                           <div class="col-md-6">
							...
							<div class="col-md-6"> <input
								type="text" class="form-control" 
								id="respondentAddress" name="respondentAddress" placeholder="address"  />
						</div>
						...
						<div class="col-md-6">
							...
							<div class="col-md-6"><select
								class="form-control" id="mandalId" name="mandalId"
						...
						<div class="col-md-6" id="component">
							<label class="label-control rowlebel ">Select Village</label> 
							</div>
							<div class="col-md-6"><select
								class="form-control" id="villageId"   name="villageId">
...
<div class="col-md-6">
						...
						<div class="col-md-6">	<select class="form-control" id="unitId"  name="unitId" onchange="getCircles()">
							<option value="0">--select --</option>
					...
					<div class="row show-grid">
                       <div class="col-md-12 ">
							<label class="label-control rowlebel "></label><input
								...
								id="addrespondent" value="Add Respondent" onclick="loadaddresform()">
						</div>
...
$(function () {
	 $('#res').parsley().on('field:validated', function() {
		  ...
		  .on('form:submit', function() {
			 // alert("coming here");
			  ...
			  document.forms.res.action="../web/addRes";
