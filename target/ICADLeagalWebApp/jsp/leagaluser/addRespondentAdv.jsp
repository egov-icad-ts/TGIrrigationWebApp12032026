...
$('#adgwefryewry').click(function() {
	...
	/* 
	function loadaddresadvform(){
		
		alert("kal is here")
		
		  $('#resAdv').attr('action', "../web/addResAdv");
          $("#resAdv").submit();
	...
	<div class="page">
		...
		<div class="panel panel-primary ">
			<div class="panel-heading">
				<h3 class="panel-title">Add Respondent Advocate</h3>
			</div>
<form:form id="resAdv" method="post" modelAttribute="respondentAdv" data-parsley-validate-if-empty="" >
			<div class='container'>
						...
						<div class="col-md-3"></div>
                           <div class="col-md-6">
                           <div class="col-md-6">
							<label class="label-control rowlebel ">RespondentAdv Name</label>
							...
							<label class="label-control rowlebel ">RespondentAdv Address</label>
							</div>
							<div class="col-md-6"> <input
								type="text" class="form-control" 
								id="respondentAddress" name="respondentAddress" placeholder="Government Pleader for Land Acquisition"  />
						</div>
						
						
						<div class="col-md-6">

							<label class="label-control rowlebel ">RespondentAdv Code</label>
							</div>
							
							<div class="col-md-6"> <input
								type="text" class="form-control" 
								id="resAdvCode" name="resAdvCode" placeholder="3456"  value="0"  required data-parsley-trigger="keyup" data-parsley-type="number" />
						</div>
								</div>
								<div class="col-md-3"></div>
						</div>
...
$(function () {
	 $('#resAdv').parsley().on('field:validated', function() {
		  ...
		  .on('form:submit', function() {
			 // alert("coming here");
			  ...
			  document.forms.resAdv.action="../web/addResAdv";
				 document.forms.resAdv.submit(); 
