...
<div class="col-md-9">
				...
				<div id="result" class="col-md-12 ">
					...
					<div class="breadcrumb">
						<a class="breadcrumb__step breadcrumb__step--active"
							href="#tab1-content">Add queries</a> <a
							class="breadcrumb__step" href="#tab2-content">Number of forms
							Service</a> <a class="breadcrumb__step" href="#tab3-content">test2
							</a> <a class="breadcrumb__step" href="#tab4-content">Documents
								...
								<div class="col-md-12">
									...
									<div class="row show-grid ">
										<div class="alert alert-info" role="alert">
											<strong style="color: #CA3F22"> Note: select query
								 </strong> <br>
 ...
 <label class="label-control rowlebel ">Available Items</label>
...
<label class="label-control rowlebel ">Selected Items</label>
