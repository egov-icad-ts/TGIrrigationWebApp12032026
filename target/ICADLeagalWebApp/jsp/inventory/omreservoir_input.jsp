...
<div>
	...
	<div class="panel panel-primary " >
		<div class="panel-heading">
			<h3 class="panel-title">O&M of Inventory:Operation of Reservoir</h3>
		</div>
		...
		<div class="col-md-6">
						<label class="label-controlPMS rowlebel ">Select Reservoir: <font
							color=red>*</font>
						</label>
					</div>
					...
					<div class="col-md-6">
						<select class="form-control" id="pumphouseId" name="pumphouseId"
							...
							<option value=" ">Reservoir 1</option>
							<option value=" ">Reservoir 2</option>

						</select>
					</div>
					
						<div class="col-md-6">
						<label class="label-controlPMS rowlebel ">Select Components: <font
							color=red>*</font>
						</label>
					</div>
					...
					<div class="col-md-6">
						<select class="form-control" id="pumphouseId" name="pumphouseId"
							 required>
							<option value=" ">--select--</option>
							<option value=" ">Components1</option>
							<option value=" ">Components1</option>
	...
	<div class="wrapper">
			...
			<div id="tabs">
				<ul>
					...
					<li><a href="#elecparams">Gates Parameters</a></li>
				...
				<div id="elecparams">
					...
					<form method="post" action="LoginController">
						<label class="label-control rowlebel " for="parameter1">parameter3</label> <br /> 
					<input  	type="text" class="form-control" id="parameter1" name="parameter1" 	placeholder="parameter1" required /> 
				<label class="label-control rowlebel " for="parameter2">parameter4</label> <br /> 
					<input  	type="text" class="form-control" id="parameter2" name="parameter2" 	placeholder="parameter2" required /> <br />
						<br />
					</form>
				</div>
