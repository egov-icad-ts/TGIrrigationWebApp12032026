...
<div>
	...
	<div class="panel panel-primary"    >
			<div class="panel-heading  ">
				<h3 class="panel-title">Unit wise cricle wise division-Ayacut<c:if test="${userObj!=null}">	
...
<div class="alert alert-info" role="alert">
				...
				<br>
				<strong style="color:#CA3F22"> Note2: Package List is From PMS. They will be changed automatically With respect to PMS.</strong>
				<br>
				<strong style="color:#CA3F22"> Note3: 'NA' under Circle Name and  'NA' Division Name means ayacut entered from CE office login/Se office login .</strong>
				<br>
						...
						<table class="display table-bordered " id="table1">
							...
							<tbody>
								...
								<c:if test="${ayacutList!=null}">
									...
									<c:if test="${ (t.districtId!=-1 && t.mandalId!=-1) &&
									                (t.divisionId!=-2 && t.districtId!=-2 && t.mandalId!=-2) &&
									                (t.circleId!=-3 && t.divisionId!=-3 && t.districtId!=-3 &&  t.mandalId!=-3)
									                    }">
										...
										<tr style="text-align: center;">
											...
											<td style="color: black; "><b><c:out value="${t.circleName}"></c:out></b></td>
                                                      <td style="color: black; "><b><c:out value="${t.divisionName}"></c:out></b></td>
                                                      	<td  style="color: black; " ><c:out value="${t.mandalName}"></c:out> </td>	
											
															
											<td   style="color:black" ><c:out value="${t.contemplatedAyacut}"></c:out> </td>
											<td  style="color:black" ><c:out value="${t.ayacutCreated}"></c:out> </td>
											<td  style="color:black" ><c:out value="${t.irriagtedAyacut}"></c:out> </td>	
											<%-- <td   style="color:black" ><c:out value="${t.stableAyacut}"></c:out> </td>	 --%>
							...
							<c:if test="${(t.divisionId==-2 && t.districtId==-2 && t.mandalId==-2) }">
							...
							<c:if test="${t.circleId==-3 && t.divisionId==-3 &&  t.districtId==-3 && t.mandalId==-3 }">
   ...
   $('#table1').DataTable( {
        ...
        buttons: [
            ...
            },
            {
                ...
                messageTop: 'Project-Package-Mandal Ayacut Report',
                	 exportOptions: {
                         columns: ':visible'
                     }
            ...
            
            {
                ...
                title: 'Unit-Circle-Division Ayacut Report',
