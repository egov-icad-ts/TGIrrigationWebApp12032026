...
<script src="../js/treeview/jquery.treeview.js" type="text/javascript"></script>
 ...
 <link rel="stylesheet" href="../css/Html5DataTable/jquery.dataTables.min.css" />
	...
	<!-- <link rel="stylesheet" href=" ../css/Html5DataTable/fixedHeader.dataTables.min.css" />  -->

	<!-- <link rel="stylesheet" href=" ../css/Html5DataTable/buttons.bootstrap.min.css" /> 
	<link rel="stylesheet" href=" ../css/Html5DataTable/buttons.dataTables.min.css" />  -->
...
<div>
	...
	<div  id="printable" class="panel panel-primary  ">
			<div class="panel-heading">
				<h3 class="panel-title">Project Wise CE's Ayacut<c:if test="${userObj!=null}">	
...
<div class="alert alert-info" role="alert">
				<strong style="color:#CA3F22"> Note: Please click on Exclude for Print/Export button  for exporting data without Package/Unit/Mandal/District/Constituency</strong>
				<br>
				<strong style="color:#CA3F22"> Note: Ayacut in Acres</strong>
		              ...
		              <div class="table-responsive" id="printarea">     
						...
						<thead class="fixhead" style="top:0px;left:auto;right:auto">
					...
					<!-- 	<th>Stabilized Ayacut</th> -->
						...
						<%-- 	<td><c:out value="${y.stableAyacut}"></c:out> </td> --%>
							...
							<td  ><c:out value="${y.mandalName}"></c:out>  </td>
...
<!-- //main-content -->
	...
	<!-- <script src="../js/Html5DataTable/dataTables.fixedHeader.min.js" type="text/javascript"></script> -->
	<!-- <script src="../js/Html5DataTable/dataTables.bootstrap.min.js" type="text/javascript"></script>
	<script src="../js/Html5DataTable/buttons.bootstrap.min.js" type="text/javascript"></script>
 -->
    ...
    $('#table').DataTable( {
        ...
        buttons: [
                  ...
                  },
            {
                ...
                messageTop: 'Project Total Ayacut',
                exportOptions: {
                    columns: ':visible'
                }
