...
<div>
	...
	<div class="panel panel-primary"    >
			<div class="panel-heading  ">
				<h3 class="panel-title">Project-Ayacut-Constituency Report<c:if test="${userObj!=null}">	
...
<form:form id="casesReport" method="post"
	...
	<div class="row show-grid">
		...
		<div class="col-md-4">
				<a href="javascript:void(0)" onclick="getConsttotalAyacutReport(<c:out value="${constList[0].constId}"></c:out>)" >	<input type="button" class="btn btn-1 btn-primary center-block"
			...
			<div class="show-grid gridList "  	style="display: block">
		              ...
		              <div class="table-responsive" id="printarea">
						...
						<c:forEach items="${constList}" var="y" varStatus="count">
							...
							<%-- <td style="text-align: center;" ><c:out value="${y.remarks}"></c:out>  </td> --%>
							</tr> 
