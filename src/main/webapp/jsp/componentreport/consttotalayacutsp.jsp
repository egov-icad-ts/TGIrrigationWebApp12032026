...
function getDistTotalayacutReport(constId)
{
	//alert("constId"+constId);
	 $("#constId").val(constId);
		 ...
		 //alert("coming here"+constId);
	
	 var act2="../compReport/getdist-total-ayacut-report";
...
function getprojtotalDistAyacutReport(constId)
{
	//alert("constId"+constId);
	 $("#constId").val(constId);
	 ...
	 var act2="../compReport/getprojtotalDistAyacutReport";
	 var newformId2="#"+formId;
	   $(newformId2).attr("action", act2);
	   $(newformId2).submit(); 
	...
	function getprojtotalAyacutReport(constId){
 ...
 $("#constId").val(constId);
	 ...
	 var act2="../compReport/getprojtotalAyacutReport";
	 var newformId2="#"+formId;
	   $(newformId2).attr("action", act2);
	   $(newformId2).submit(); 
...
<div>
			...
			<div class="panel-heading">
				<h3 class="panel-title">Constituency Wise-Ayacut<c:if test="${userObj!=null}">	
...
<div class="alert alert-info" role="alert">
				<strong style="color:#CA3F22"> Note: Please click on Exclude for Print/Export button  for exporting data without Project/Package/Unit/District</strong>
				<br>
			...
			<div class="show-grid gridList "  	style="display: block">
		              ...
		              <div class="table-responsive" id="printarea">  		
						...
						<c:forEach items="${constList}" var="y" varStatus="count">
							...
							<td style="color: blue; "><a   href="javascript:void(0);" onclick="getDistTotalayacutReport(${y.constId})"><u><c:out value="${y.constName}"></c:out> </u></a></td>
							...
							<%-- <td  ><c:out value="${y.stableAyacut}"></c:out> </td> --%>
							 ...
							 <td style="color: blue" ><a   href="javascript:void(0);" onclick="getprojtotalAyacutReport(${y.constId})" ><u><c:out value="${y.projectName}"></c:out></u> </a></td>
							  <td style="color: blue" ><c:out value="${y.packageName}"></c:out> </td>
							<td ><b><c:out value="${y.unitName}"></c:out></b></td>
							<td  ><a   href="javascript:void(0);" onclick="getprojtotalDistAyacutReport(${y.constId}) " ><u><c:out value="${y.districtName}"></c:out></u>  </a></td>
							...
							<td><c:out value="${totalConstContemplatedAyacyt}"></c:out> </td>
    ...
    $('#table').DataTable( {
        ...
        buttons: [
                  ...
                  },
            {
                ...
                messageTop: 'Constituency Ayacut Report',
                exportOptions: {
                    columns: ':visible'
                }
            ...
            
            {
                ...
                title: 'Constituency Ayacut Report',
