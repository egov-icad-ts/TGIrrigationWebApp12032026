...
function getConstProjectAyacut(districtId)
{
	...
	document.forms[0].urlvalue.value="../compReport/getconst-proj-ayacut-report";
...
<div>
			...
			<div class="panel-heading">
				<h3 class="panel-title">Constituency Wise Project-Ayacut
					...
					<!-- 	<th>Stabilized Ayacut</th> -->
						...
						<c:if test="${y.projectId!=-3 }">
							...
							<td style="color: blue" ><c:out value="${y.projectName}"></c:out> </td>
								...
								<td style="color: green;text-align: center;" ><c:out value="${y.contemplatedAyacut}"></c:out> </td>
								<td style="color: green;text-align: center;" ><c:out value="${y.ayacutCreated}"></c:out> </td>
							<td style="color: green;text-align: center;" ><c:out value="${y.irriagtedAyacut}"></c:out> </td>
							
						<%-- 	<td style="color: green;text-align: center;" ><c:out value="${y.stableAyacut}"></c:out> </td> --%>
							<td ><b><c:out value="${y.packageName}"></c:out></b></td>
							<td ><b><c:out value="${y.unitName}"></c:out></b></td>
							
							<td  style="color: blue"><b><c:out value="${y.mandalName}"></c:out></b></td>
    ...
    $('#table').DataTable( {
        ...
        buttons: [
            ...
            },
            {
                ...
                messageTop: 'Constituency Project Ayacut Report',
           	 exportOptions: {
                 columns: ':visible'
             }
            ...
            
            {
                ...
                title: 'Constituency Project Ayacut Report',
