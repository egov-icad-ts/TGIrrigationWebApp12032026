...
function getConstMandalAyacut(districtId)
{
	...
	document.forms[0].urlvalue.value="../compReport/getcomp-ayacut-report";
...
<div>
	...
	<div class="panel panel-primary"    >
			<div class="panel-heading  ">
				<h3 class="panel-title">Constituency Wise Mandal-Ayacut<c:if test="${userObj!=null}">	
...
<c:forEach items="${distList}" var="d">
						...
						<%-- ../compReport/getCompAyacutReport?districtId=<c:out value="${d.districtId}"></c:out>  --%>			
								
	<li><a class="myunit"  href="javascript:void(0)" onclick="getConstMandalAyacut(<c:out value="${d.districtId}"></c:out> )" ><strong><c:out value="${d.districtName}"></c:out></strong></a>
...
<div class="alert alert-info" role="alert">
				...
				<strong style="color:#CA3F22"> Note2: Please click on Exclude for Print/Export button  for exporting data without Project/Package/Unit/District</strong>
				<br>
    ...
    $('#table1').DataTable( {
        ...
        buttons: [
                  ...
                  },
            {
                ...
                messageTop: 'Constituency Mandal Ayacut Report',
                exportOptions: {
                    columns: ':visible'
                }
            ...
            
            {
                ...
                title: 'Constituency Mandal Ayacut Report',
