...
function getVillageByIdAyacutReport(districtId,constId,mandalId)
{
	//alert("constId"+constId);
	 $("#constId").val(constId);
	 $("#districtId").val(districtId);
	
	 $("#mandalId").val(mandalId);
	...
	alert("kal2"+ $("#constId").val());
	 ...
	 var act2="../compReport/getVillageByIdAyacutReport";
...
<div>
	...
	<div  id="printable" class="panel panel-primary ">
			<div class="panel-heading">
				<h3 class="panel-title">Mandal Ayacut Report<c:if test="${userObj!=null}">	
...
<div class="alert alert-info" role="alert">
	...
	<div class="row show-grid">
		...
		<div class="col-md-4">
				<a href="javascript:void(0)" onclick="getDistTotalAyacutReport(<c:out value="${constList[0].constId}"></c:out>)" >	<input type="button" class="btn btn-1 btn-primary center-block"
	 ...
	 <br>
					...
					<!-- 	<th>Stabilized Ayacut</th> -->
						...
						<c:forEach items="${constList}" var="y" varStatus="count">
							...
							<tr  style="text-align: center;"><td style="text-align: center;"  >${count.count}</td>
							
							
							<td  ><c:out value="${y.districtName}"></c:out>  </td>
							 <td style="color: blue"  ><u><a   href="javascript:void(0)" onclick="getVillageByIdAyacutReport(${y.districtId},${y.constId},${y.mandalId})" ><c:out value="${y.mandalName}"></c:out></a></u> </td>
