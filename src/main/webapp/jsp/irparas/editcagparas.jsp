...
function editcagparas(){
	...
	alert("coming here");
	 ...
	 $('#editFlag').val(true);
	 	 ...
	 	 document.forms[0].urlvalue.value="../parastsimis/editcagparas";
...
<div class="col-md-6">
                                      ...
                                      <br></br>
										...
										<option value=" ">--select--</option> 
										<option value="4" ${paraDBObj.paraStatusId == '4' ? 'selected' : ''}>Reply Sent to Government</option>
 ...
 <div class="col-md-9"  >
        <textarea  name="actionTitle" id="actionTitle" class="  form-control "  rows="2" cols="80"   required >${paraDBObj.actionTitle} </textarea>
        </div>
											 </div>							
