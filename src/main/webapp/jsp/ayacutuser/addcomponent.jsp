...
<form:form id="pack" method="post" modelAttribute="pack"  data-parsley-validate-if-empty="">
			<div class='container'>
   ...
   <div class="row show-grid">
	<div class="col-md-12">
	<h4  style="color:blue ;margin:1em; font-weight: bold;"> Note: Enter Component one time only and length of component in total .  </h4>
	</div>
					...
					<div class="row show-grid">
					 ...
					 <div class="col-md-2">
							...
							<label class="label-control rowlebel ">Component category</label> <input
								type="text" class="form-control" 
								id="pkgName" name="pkgName" placeholder="RMC Main Canal"  required />
						</div>
						

                   <div class="col-md-2">
							<label class="label-controlPMS rowlebel ">Select component Type</label>
							<select class="form-control" id="unitId"  name="unitId" >
							<option value="0">Main Canal</option>
							<option value="0">Districutory</option>
							<option value="0">Minor</option>
							<option value="0">Sub Minor</option>
							<option value="0">pump house Structure</option>
							<option value="0">reservoir submergence</option>
						...
						<div class="col-md-2">
							<label class="label-controlPMS rowlebel ">Select Canal Direction</label>
							...
							<div class="col-md-2">
							<label class="label-controlPMS rowlebel ">Select  Canal Lined/unlined</label>
							<select class="form-control" id="circleId"  name="circleId" onchange="getDivisions()">
							<option value="0">Lined</option>
							<option value="0">unlined</option>
						...
						<div class="col-md-2">
							<label class="label-controlPMS rowlebel ">Select parent Component</label>
							<select class="form-control" id="divisionId"  name="divisionId" onchange="getSubDivisions()">
							<option value="0">RMC1</option>
							<option value="0">LMC2</option>
						...
						<div class="col-md-2">
							...
							<label class="label-control rowlebel ">Component Name</label> <input
								type="text" class="form-control" 
								id="pkgName" name="pkgName" placeholder="RMC Main Canal"  required />
						</div>
						...
						<div class="col-md-2">
							...
							<label class="label-control rowlebel ">Reservoir capacity</label> <input
								type="text" class="form-control" 
								id="pkgName" name="pkgName" placeholder="RMC Main Canal"  required />
						</div>
						...
						<div class="col-md-2">
							...
							<label class="label-control rowlebel ">Lift capacity</label> <input
								type="text" class="form-control" 
								id="pkgName" name="pkgName" placeholder="RMC Main Canal"  required />
						</div>
						...
						<div class="col-md-2">
							...
							<label class="label-control rowlebel ">off take point</label> <input
								type="text" class="form-control" 
								id="pkgName" name="pkgName" placeholder="from km"  required />
						</div>
						<div class="col-md-2">
						...
						<div class="col-md-2">
							...
							<label class="label-control rowlebel ">To Km</label> <input
								type="text" class="form-control" 
								id="pkgName" name="pkgName" placeholder="to km"  required />
						</div>
