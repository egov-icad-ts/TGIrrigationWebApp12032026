	...
	<div class="page">
		...
		<div class="panel panel-primary ">
			<div class="panel-heading">
				<h3 class="panel-title">Add Ayacut</h3>
			</div>
...
<div class="col-md-2">
							<label class="label-controlPMS rowlebel ">Select Component</label>
							<select class="form-control" id="unitId"  name="unitId" >
							<option value="0">--RMC1-from 0 to 10  --</option>
							<option value="0">--RMC1-from 0 to 10   --</option>
							<option value="0">--RMC1-from 0 to 10  --</option>
						...
						<div class="col-md-2">
							<label class="label-controlPMS rowlebel ">Select Constituency </label>
						...
						<div class="col-md-2">
							...
							<label class="label-control rowlebel ">From km </label> <input
								...
								id="pkgName" name="pkgName" placeholder="pack Name"  required />
						</div>
