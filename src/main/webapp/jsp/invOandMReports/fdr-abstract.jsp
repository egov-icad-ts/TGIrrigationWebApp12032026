...
<link rel="stylesheet"
	...
	<script type="text/javascript" src="../js/invomReports/fdr_report.js"></script>
					...
					<!-- 	 <div class="col-md-12 invDiv">
					 ...
					 <li><a href="#tcab1" data-toggle="tab" >Form 20 Tanks Abstract</a></li>
						...
						<div id="tcab1" class="col-md-12 ">	
								...
								<div class="row show-grid ">
<div class="alert alert-info" role="alert">
				<strong style="color:#CA3F22"> Note: Abstract</strong>
				<br>
		...
		<div class="show-grid gridList "  id="cap-detail-data-1" 	style="display: block">
		              ...
		              <div class="table-responsive" id="printarea">
						...
						<table class="display table-bordered  table1" id="t-form-1">
	                      ...
	                      <th rowspan="1" colspan="2">Minor Irrigation Tanks (Bund/weir/sluice/ canals)</th>
	                       <th rowspan="1" colspan="2">Projects Reservoirs</th>
	                        <th rowspan="1" colspan="2" >Projects/Canals & others</th>
	                           <th rowspan="1" colspan="2">Major lifts</th>
	                             <th rowspan="1" colspan="2">Small L.I schemes (IDC)</th>
	                               <th rowspan="1" colspan="1">Total amount in lakhs</th>
	                            <th rowspan="1" colspan="1">Temporary amount in  lakhs</th>
	                             <th rowspan="1" colspan="1">Permanent amount in  lakhs</th>
	                              <th rowspan="1" colspan="2">No. of damages restored temporarily</th>
	                                <th rowspan="1" colspan="2">No. of damages restored permanently</th>
	                                <th rowspan="2" >No. of damages under restoration</th>
	                                 <th rowspan="2" >No. of damages to be restored</th>                      
						...
						<c:set var="prevUnitId" value="0" scope="page" />
							
							<c:forEach items="${form20Abstract}" var="f" varStatus="count">	
							
								
								  <c:if test="${f.unitId ne prevUnitId}">
									<tr style="font-size: 12px ; text-align: center;">
                                       ...
                                       <%--   <c:out value="2 CE SE nt ENCA or I"></c:out> --%>
										...
										<td><button type="button" name="officeTankfm" id="officeTankfrm20${count.count}" class="btn btn-1 btn-primary center-block "    style="white-space:normal"  onclick="getForm20tanks('${frmYear }','${frmdesgId}','${f.unitId}','${f.circleId}','${f.divisionId}','${f.subDivisionId}','${f.postId}','${f.catId }' ,'${frmYear}','${fromdate}' ,'${todate}' )"  >    <b><c:out value="${f.unitName}"></c:out></b> </button></td>
										...
										<td><button type="button" name="officeTankfm" id="officeTankfrm20${count.count}" class="btn btn-1 btn-primary center-block "    style="white-space:normal"  onclick="getForm20tanks('${frmYear }','${frmdesgId}','${f.unitId}','${f.circleId}','${f.divisionId}','${f.subDivisionId}','${f.postId}','${f.catId }' ,'${frmYear}','${fromdate}' ,'${todate}' )"  >   <b><c:out value="${f.unitName}"></c:out></b> </button></td>
									         ...
									         <td><b>${f.tankDamages}</b></td>
									           <td><b>${f.tankBreaches}</b></td>
									           
									             <td><b>${f.resDamages}</b></td>
									           <td><b>${f.resBreaches}</b></td>
									           
									           
									             <td><b>${f.canalDamages}</b></td>
									           <td><b>${f.canalBreaches}</b></td>		          
									        ...
									        <td>${f.temporaryCount}</td>
											<td>${f.temporaryAmount}</td> 
									       
											<td>${f.permanentCount}</td>
											<td>${f.permanentAmount}</td>
											
											<td>${f.restoredCount}</td>
											<td>${f.underRestoredCount}</td>
									 ...
									 <c:set var="prevUnitId" value="${f.unitId}" scope="page"/>
									    </c:if>
								...
								<td>--</td>
								<td>Total</td>
									<td>${totalTankDamages }</td>
								<td>${totalTankBreaches }</td>
								<td>${totalResDamages}</td>
								<td>${totalResBreaches}</td>
								<td>${totalCanalDamages}</td>
								<td>${totalCanalBreaches}</td>
								<td>0</td>
								<td>0</td>
								<td>0</td>
								<td>0</td>								
								<td>${finalSumtotalAtr}</td>
								<td>${finalSumtotalAtc}</td>
								<td>${sumrtotalApc }</td>
								<td>${totalTemporaryCount}</td>
							
							<td>${totalTemporaryAmount}</td>
								<td>${totalPermanentCount}</td>
								<td>${totalPermanentAmount}</td>
								
								<td>${totalRestoredCount}</td>
								<td>${totalUnderRestoredCount}</td>
				...
				<div class="show-grid gridList "  id="form-detail-data-1" 	style="display: block">
		              ...
		              <div class="table-responsive" id="printarea">
						<table class="display table-bordered  table1" id="form-detail-1">
	                      ...
	                      <th rowspan="1" colspan="1">Sl.No</th>
	                        <th rowspan="1" colspan="1">Date of Damage</th>
	                          <th rowspan="1" colspan="1">GEO ID of the tank</th>
	                          <th rowspan="1" colspan="1">UID Of the Tank</th>
	                           <th rowspan="1" colspan="1">Tank Name/Project Name/Canal Name</th>
	                              <th rowspan="1" colspan="1">Village Name</th>
	                               <th rowspan="1" colspan="1">Mandal Name</th>
	                            <th rowspan="1" colspan="1">District Name</th>
	                              <th rowspan="1" colspan="1">Constituency</th>
	                             <th rowspan="1" colspan="1">Ayacut in Acres</th>
	                               <th rowspan="1"colspan=3>Component Of Damage</th>
	                               <th rowspan="1" colspan="1">If Breached Length in(M)</th>
	                                <th rowspan="1" colspan="1">Rain fall mm on the day of Breach/damage</th>
	                                 <th rowspan="1" colspan="2">Amount Required for</th>
	                                  <th rowspan="1" colspan="1">Restored</th>
	                                   <th rowspan="1" colspan="1">Under Restoration</th>
	                                     <th rowspan="1" colspan="1">Not Restored</th>                     
							...
							<th rowspan="1" colspan="2">Breach</th>
							<th rowspan="1" colspan="1">Damage</th>
							<th></th>
							
							<th rowspan="1" colspan="1">"Temporary repairs Rs. In lakhs)" </th>
							<th rowspan="1" colspan="1">"Permanent repairs (Rs. In lakhs)"  </th>	
							<th></th>
							<th></th>
							<th></th>
							...
							<th></th>
							<th></th>
							<th>Bund/Weir/Sluice</th>
							<th>Canals</th>
							<th>Bungas and Others</th>
							<th></th>
							
							<th>"Temporary repairs Rs. In lakhs)" </th>
							<th>"Permanent repairs (Rs. In lakhs)"  </th>	
							<th></th>
							<th></th>
							<th></th>
							...
							<c:forEach items="${miTankForm20detail}" var="t" varStatus="count">		
									...
									<tr style="font-size: 12px">
										...
										<td style="text-align: center;"><c:out
												value="${count.count}"></c:out></td>
												<td ><b><c:out value="${t.tankCode}"></c:out></b></td>	
													<td ><b><c:out value="${t.tankGeoId}"></c:out></b></td>	
										...
										<td><b><c:out value="${t.constituencyName}"></c:out></b></td>	
										<td><b><c:out value="${t.ayacutAcres}"></c:out></b></td>	
										<td><b><c:out value="${t.srcname}"></c:out></b></td>	
										<td><b><c:out value="${t.srcname}"></c:out></b></td>	
										<td><b><c:out value="${t.breachLength}"></c:out></b></td>
										<td><b><c:out value="${t.rainQty}"></c:out></b></td>	
										<td><b><c:out value="${t.sumAprxCostPermt}"></c:out></b></td>	
										<td><b><c:out value="${t.sumAprxCostTemp}"></c:out></b></td>
										<td><b><c:out value="${t.restored}"></c:out></b></td>				
