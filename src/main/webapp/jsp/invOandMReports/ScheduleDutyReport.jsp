...
<title>O&M Schedule duty Checks</title>
...
function getresabstractdata()
{
	
//alert(cagGistId);

 var fromdate=$("#fromDate1").val();
 var todate=$("#fromDate2").val();
 var freqid=$("#dutyFrequencyId").val();
 alert("fromdate"+fromdate);
 alert("todate"+todate);
 alert("freqid"+freqid);
	document.forms[0].urlvalue.value="../invReport/Schedule-Duty-Report";
	...
	<div>
		...
		<div class="panel panel-primary" style="padding: 10px">
			<div class="panel-heading">
				<h3 class="panel-title">O&M of Reservoir:Reservoir Duty Schedule Report</h3>
			</div>
...
<div class="alert alert-info" >
	...
	<form:form id="casesReport" method="post" modelAttribute="scheduleduty">
	...
	<input name=newDistrictId id="newDistrictId" type=hidden>
		...
		<div class="col-md-12  invDiv">	
											 ...
											 <div class="col-md-2">
											<label class="label-control rowlebel ">Select From Date <font color=red>*</font> </label>
											</div>
											...
											<input type="text"
															...
															id="fromDate1"
															name="fromDate1" readonly="readonly"
															 /></div> 
											 
											  <div class="col-md-2">
											<label class="label-control rowlebel ">Select To Date <font color=red>*</font> </label>
											</div>
											...
											<input type="text"
															class=" datepick form-control datepicker"
															id="fromDate2"
															name="fromDate2"  readonly="readonly"
															/></div> 
															
															<div class="col-md-2">
											<label class="label-control rowlebel ">Select Operational Frequency <font color=red>*</font> </label>
											</div>
											
											<div class="col-md-2">
											 <select class="form-control" id="dutyFrequencyId" name="dutyFrequencyId" required onchange="getresabstractdata()" > 
											   ...
											   <option value="4">Quarterly</option>
											    <option value="5">Half Yearly</option>
											     <option value="6">Yearly</option>
											      <option value="7">Every 5 Years</option>
											       <option value="8">Monthly During Monsoon</option>
						...
						<table class=" display table-bordered" style="width: 100%"
							...
							<thead>
								...
								<tr style="font-size: 18px">
									...
									<th >Designation</th>
									<c:if test="${aeedaily!=null}">
									<th >Inspect Date</th>
									
									</c:if>
									<c:if test="${aeeweekly!=null}">
									...
									<c:if test="${headth!=null}">
									<th >Total Count <c:out value="${totaldutycount}"></c:out>/<c:out value="${headth}"></c:out>  Count Completed</th>
									</c:if>
							...
							<tbody>
								...
								<c:forEach items="${aeedaily}" var="t" varStatus="count">
									...
									<tr style="font-size: 16px">
										...
										<td><b><c:out value="${t.unitName}"></c:out></b></td>
											...
											<td><b><c:out value="${t.designationName}"></c:out></b></td>
											<td><b><c:out value="${t.inspectDate}"></c:out></b></td>
											<td><a 	href="javascript:void(null);" onclick="getResInfo1('${t.resCode}','${t.inspectDate}','${t.unitId}','${t.designationId}','${t.dutyFrequencyId}');"><b><c:out value="${t.aeedailyCount}"></c:out></b></a></td>
											
											
											<%-- <td><b><c:out value="${t.resName}"></c:out></b></td>
											<td><b><c:out value="${t.resName}"></c:out></b></td>  --%>
									<%-- 	<td><a 	href="javascript:void(null);" ><c:out  value="${t.}"></c:out></a></td> --%>


									<%-- 	<td><a 	href="javascript:void(null);" onclick="getResInfo('${t.resCode}','${t.year}','${t.unitId}');"><c:out value="${t.resInspectCount}"></c:out></a></td> --%>
									...
									<c:forEach items="${aeeweekly}" var="t" varStatus="count">
									<%-- <a target="_blank"  href="../parasreport/cagParasAbstractOffice?unitId=<c:out value="${t.unitId}"></c:out>" ></a> --%>
									<tr style="font-size: 16px">
										...
										<td><b><c:out value="${t.unitName}"></c:out></b></td>
											<td><b><c:out value="${t.resName}"></c:out></b></td>
											<td><b><c:out value="${t.designationName}"></c:out></b></td>
											<td><b><c:out value="${t.weekstartDate}"></c:out></b></td>
											<td><b><c:out value="${t.weekendDate}"></c:out></b></td>
											
											<td><a 	href="javascript:void(null);" onclick="getResInfo2('${t.resCode}','${t.weekstartDate}','${t.weekendDate}','${t.unitId}','${t.designationId}','${t.dutyFrequencyId}');"><b><c:out value="${t.aeeweeklycount}"></c:out></b></a></td>
...
<!-- //container-content -->
	...
	<div id="dialog-para" title="Reservoir Schedule Duty Report" style="display:none">
...
<script type="text/javascript">
function getResInfo1(rescode,inspectdate,unitId,designationId,dutyfreqId){
	
	
$.ajax({
    type: "GET", //rest Type
    dataType: 'json', //mispelled
    url: "../invReport/sch-res-Info?resCode="+rescode+"&inspectDate="+inspectdate+"&unitId="+unitId+"&designationId="+designationId+"&dutyFrequencyId="+dutyfreqId,
    async: false,
    ...
    success: function (msg) {
        console.log(msg); 
         ...
         $("#dialog-para1").append('<div  class="col-md-3 " style="font-weight:bold;" > Circle Name  </div> <div  class="col-md-3 " style="font-weight:bold;" > : '+msg[0].projectName +'</div><div  class="col-md-3 " style="font-weight:bold;" >  Inspection Date </div> <div  class="col-md-3 " style="font-weight:bold;" > : '+ msg[0].inspectDate +'</div>');
...
$.ajax({
    type: "GET", //rest Type
    dataType: 'json', //mispelled
    url: "../invReport/sch-inpsect-info?resCode="+rescode+"&inspectDate="+inspectdate+"&unitId="+unitId+"&designationId="+designationId+"&dutyFrequencyId="+dutyfreqId,
    async: false,
    contentType: "application/json; charset=utf-8",
 ...
 */
 ...
 $('#gen').append('<div  class="row col-md-12 invDiv" style="font-weight:bold;color:black" ><h3>Inspection Info</h3></div>')
 $("#gen").append('<div  class="row col-md-12 invDiv" style="font-weight:bold;color:blue" > <div  class="col-md-2 " style="font-weight:bold;" >Inspection Name</div><div  class="col-md-2 " style="font-weight:bold;" >Designation</div><div  class="col-md-2 " style="font-weight:bold;" >Action required</div><div  class="col-md-2 " style="font-weight:bold;" >Action Type</div><div  class="col-md-2 " style="font-weight:bold;" >  Remarks</div> <div  class="col-md-2 " style="font-weight:bold;" >Status</div></div>');
 for(i in  msg2 ){
	 var j=parseInt(i)+1; 
 	
	 
         $("#gen").append('<div  class="row col-md-12" > <div  class="col-md-2 invDiv" style="font-weight:bold;" > '+msg2[i].dutyName+' </div> <div  class="col-md-2 " style="font-weight:bold;" >  '+msg2[i].designationName+'</div>  <div  class="col-md-2 " style="font-weight:bold;" >  '+msg2[i].action+'</div> <div  class="col-md-2 " style="font-weight:bold;" >  '+msg2[i].actionReqName+'</div> <div  class="col-md-2 " style="font-weight:bold;" >  '+msg2[i].remarks+'</div><div  class="col-md-2 " style="font-weight:bold;" >  '+msg2[i].approveStatus+'</div></div>'); 
...
function getResInfo2(rescode,startDate,enddate,unitId,designationId,dutyfreqId){
	
	
	$.ajax({
	    type: "GET", //rest Type
	    dataType: 'json', //mispelled
	    url: "../invReport/sch-res-Info?resCode="+rescode+"&weekstartDate="+startDate+"&weekendDate="+enddate+"&unitId="+unitId+"&designationId="+designationId+"&dutyFrequencyId="+dutyfreqId,
	    async: false,
	    contentType: "application/json; charset=utf-8",
	    success: function (msg) {
	        console.log(msg); 
	         ...
	         $("#dialog-para1").append('<div  class="col-md-3 " style="font-weight:bold;" > Circle Name  </div> <div  class="col-md-3 " style="font-weight:bold;" > : '+msg[0].projectName +'</div>');
	...
	$.ajax({
	    type: "GET", //rest Type
	    dataType: 'json', //mispelled
	    url: "../invReport/sch-inpsect-info?resCode="+rescode+"&weekstartDate="+startDate+"&weekendDate="+enddate+"&unitId="+unitId+"&designationId="+designationId+"&dutyFrequencyId="+dutyfreqId,
	    async: false,
	    contentType: "application/json; charset=utf-8",
	    success: function (msg2) {
	      //  console.log(msg2); 
