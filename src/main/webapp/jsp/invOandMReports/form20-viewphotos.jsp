						...
						<div class="table-responsive" id="printarea">
							...
							<table class="display table-bordered " style="width:100%"  id="table1" >
								...
								<tbody>
										...
										<c:forEach items="${form20docList}" var="t" varStatus="count">
								  ...
								  <td style="text-align: center;" ><b>${t.formDocOriginalName}</b></td>
								  <td style="text-align: center;" ><a target="_blank" href="../invReport/viewphotos?fileName=${t.formDocName}"  download>Download File</a></td>
								  
								 
								 
								  <td style="text-align: center;" ><b><img src="../invReport/viewphotos?fileName=${t.formDocName}" alt="${t.formDocOriginalName}" class="img-responsive"/></b></td>
