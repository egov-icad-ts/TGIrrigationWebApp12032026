...
<div class="panel panel-primary ">
			<div class="panel-heading">
				<h3 class="panel-title">Petitioner </h3>
			</div>
...
<form:form id="casesReport" method="post"
       ...
       <label class="label-control rowlebel ">Select Petitioner * 
								</label> <select class="form-control" id="petitionerId" name="petitionerId"
								 required >
								
								<c:forEach items="${petList}" var="p">
								
								 <c:choose>
        <c:when test="${p.petitionerId==selectedpetitioner}">
									<option value="${p.petitionerId}" selected="selected" >${p.petitionerName}</option>
									</c:when>
		...
		<div class=" mainprint  pagecontent" >
		 ...
		 <div class="table-responsive" id="printarea"  >
						...
						<table class=" table-bordered " id="table">
							...
							<tr style="color: red; font-weight: bold; background: #ffffff;"><td></td><td>  Court Type</td><td><c:out value="${court}"></c:out></td><td></td><td></td><td> Petitioner Name:</td><td><c:out value="${petitionerName}"></c:out></td> </tr>
								<tr>
							...
							<tbody>
								<c:forEach var="c" items="${petData}" varStatus="count">
										...
										<tr>
											...
											<td><a target="_blank"  href="../webReports/petDetails?unitId=<c:out value="${c.unitId}"></c:out>  &petitionerId=<c:out value="${c.petitionerId}"></c:out> &courtId=<c:out value="${c.courtId}"></c:out>  &filingDate=1" > <c:out value="${c.casesFiled}"></c:out>   </a></td>
											<td><a  target="_blank"  href="../webReports/petDetails?unitId=<c:out value="${c.unitId}"></c:out> &petitionerId=<c:out value="${c.petitionerId}"></c:out> &courtId=<c:out value="${c.courtId}"></c:out>  &filingDate=2"> <c:out value="${c.draftCountFile}"></c:out></a></td>
											<td><a target="_blank"   href="../webReports/petDetails?unitId=<c:out value="${c.unitId}"></c:out> &petitionerId=<c:out value="${c.petitionerId}"></c:out> &courtId=<c:out value="${c.courtId}"></c:out> &filingDate=3"> <c:out value="${c.counterFiled}"></c:out></a></td>
											<td><a target="_blank"  href="../webReports/petDetails?unitId=<c:out value="${c.unitId}"></c:out> &petitionerId=<c:out value="${c.petitionerId}"></c:out>  &courtId=<c:out value="${c.courtId}"></c:out> &filingDate=4"><c:out value="${c.casesToFile}"></c:out></a></td>
											<td><a  target="_blank"  href="../webReports/petDetails?unitId=<c:out value="${c.unitId}"></c:out> &petitionerId=<c:out value="${c.petitionerId}"></c:out>  &courtId=<c:out value="${c.courtId}"></c:out> &filingDate=5"><c:out value="${c.casesJudged}"></c:out></a></td>
								...
								<tr style="color: red; font-weight: bold;"><td></td><td>  Total</td><td><a target="_blank"  style="color: red; font-weight: bold;" href="../webReports/viewCasePetTotalDetails?courtId=<c:out value="${petData[0].courtId}"></c:out>&petitionerId=<c:out value="${petData[0].petitionerId}"></c:out>&filingDate=1" ><c:out value="${petCF}"></c:out></a></td><td><a target="_blank"  style="color: red; font-weight: bold;" href="../webReports/viewCasePetTotalDetails?courtId=<c:out value="${petData[0].courtId}"></c:out>&petitionerId=<c:out value="${petData[0].petitionerId}"></c:out>&filingDate=2" ><c:out value="${petDF}"></c:out></a></td><td><a target="_blank"  style="color: red; font-weight: bold;" href="../webReports/viewCasePetTotalDetails?courtId=<c:out value="${petData[0].courtId}"></c:out>&petitionerId=<c:out value="${petData[0].petitionerId}"></c:out>&filingDate=3" ><c:out value="${petCountF}"></c:out></a></td><td><a target="_blank"  style="color: red; font-weight: bold;" href="../webReports/viewCasePetTotalDetails?courtId=<c:out value="${petData[0].courtId}"></c:out>&petitionerId=<c:out value="${petData[0].petitionerId}"></c:out>&filingDate=4" ><c:out value="${petCountNF}"></c:out></a></td><td><a target="_blank"  style="color: red; font-weight: bold;" href="../webReports/viewCasePetTotalDetails?courtId=<c:out value="${petData[0].courtId}"></c:out>&petitionerId=<c:out value="${petData[0].petitionerId}"></c:out>&filingDate=5" ><c:out value="${petJF}"></c:out></a></td> </tr>
								</tbody>
	 ...
	 $('#casesReport').parsley().on('field:validated', function() {
		  ...
		  .on('form:submit', function() {
			 // alert("coming here");
			  ...
			  document.forms.casesReport.action="../webReports/PetStatus";
