...
<c:forEach items="${unitList}" var="u">
 ...
 --%>
	...
	<li><a class="myunit"  href="../task/taskreport2?unitId=<c:out value="${u.unitId}"></c:out>" ><strong><c:out value="${u.unitName}"></c:out></strong></a>
	<ul>
	...
	<%-- ../task/taskreport2?unitId=<c:out value="${u.unitId}"></c:out>&circleId=<c:out value="${c.circleId}"></c:out> --%>
		<li><a class="mycircle" href="../task/taskreport2?unitId=<c:out value="${u.unitId}"></c:out>&circleId=<c:out value="${c.circleId}"></c:out>" ><c:out value="${c.circleName}"></c:out></a>
			<ul>
			...
			<li><a class="mydivision" href="../task/taskreport2?unitId=<c:out value="${u.unitId}"></c:out>&circleId=<c:out value="${c.circleId}"></c:out>&divisionId=<c:out value="${d.divisionId}"></c:out>" ><c:out value="${d.divisionName}"></c:out></a>
			<ul>
			<c:forEach items="${subdivisionList}" var="s">
			...
			<li><a  class="mysubdivision" href="../task/taskreport2?unitId=<c:out value="${u.unitId}"></c:out>&circleId=<c:out value="${c.circleId}"></c:out>&divisionId=<c:out value="${d.divisionId}"></c:out>&subdivisionId=<c:out value="${s.subdivisionId}"></c:out>"><c:out value="${s.subdivisionName}" ></c:out></a></li>
			</c:if>
			</c:forEach>
			</ul>
...
<!-- </div>
	...
	<div class="panel panel-primary  col-md-12">
		...
		<div class="col-md-2">
				<a href="../task/taskreport2">	<input type="button" class="btn btn-1 btn-primary center-block"
	 ...
	 <div class="w3layouts_vertical_tab resp-tab-content resp-tab-content-active  mainprint pagecontent" style="display:block"> 
		...
		<!--  <div class="row show-grid gridList  col-md-12" id="printarea"  > -->
						...
						<table class="table-responsive table-bordered " id="tableDataexport">
							...
							<tr style="color: red; font-weight: bold; background: #ffffff;"><td></td><td><c:out value="${displayunit}"></c:out></td><td><c:out value="${displayvalue}"></c:out></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td> Task Type:</td><td><c:out value="${displaytype}"></c:out> </td> </tr>
								<tr>
									...
									<th rowspan="2" >Files Uploaded</th>
							...
							<tbody>
									...
									<c:forEach items="${taskAllList}" var="t" varStatus="count">
										<tr>
											...
											<td><c:out value="${t.priority}"></c:out> </td>
		...
		<div class="row show-grid">
					...
					<div class="col-md-2">
						<input type="button" class="btn btn-1 btn-primary center-block"
							id="getExcelId" value="Excel Export" onclick="tableToExcel('tableDataexport', 'TaskReport')" >
					</div>
					...
					<div class="col-md-2">
						<input type="button" class="btn btn-1 btn-primary center-block"
							id="getprintId" value="Print"  onclick="printDiv('mainprint')" >
					</div>
					</div>
