...
function getMandals(){
	...
	/* function loadaddpetform(){
		
		alert("kal is here")
		
		  $('#pet').attr('action', "../web/addPet");
          $("#pet").submit();
	...
	<div class="page">
		...
		<div class="panel panel-primary ">
			<div class="panel-heading">
				<h3 class="panel-title">Add Petitioner</h3>
			</div>
<form:form id="pet" method="post" modelAttribute="petitioner" data-parsley-validate-if-empty="" >
			<div class='container'>
...
$(function () {
	 $('#pet').parsley().on('field:validated', function() {
		  ...
		  .on('form:submit', function() {
			 // alert("coming here");
			  ...
			  document.forms.pet.action="../web/addPet";
				 document.forms.pet.submit(); 
