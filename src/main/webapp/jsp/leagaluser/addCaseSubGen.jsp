...
$('#adgwefryewry').click(function() {
	...
	/* function loadaddcasegensubform(){
		
		alert("kal is here")
		
		  $('#casegensub').attr('action', "../web/addCaseGenSub");
          $("#casegensub").submit();
	...
	<div class="page">
		...
		<div class="panel panel-primary ">
			<div class="panel-heading">
				<h3 class="panel-title">Add Case General Sub</h3>
			</div>
<form:form id="casegensub" method="post" modelAttribute="casegensub" >
			<div class='container'>
				...
				<!-- <div class="row col-md-12 toppad "> -->
						...
						<div class="col-md-12">
							<div class="col-md-3"></div>
								<div class="col-md-6">
                              	<div class="col-md-6">
							<label class="label-control rowlebel ">Case Genral Sub Name</label>
							</div>	<div class="col-md-6"> <input
								type="text" class="form-control" 
								id="caseGenSubName" name="caseGenSubName" placeholder="Name"  required />
								</div>
								<div class="col-md-6">
							<label class="label-controlPMS rowlebel ">Select Case General Type</label>
							</div>
								<div class="col-md-6">
							<select class="form-control" id="caseGenId" name="caseGenId"   required
								>
					...
					<div class="row show-grid">
                       <div class="col-md-12">
							<label class="label-control rowlebel "></label><input
								...
								id="addcaseGenSub" value="Add Case General Sub"  >
						</div>
...
$(function () {
	 $('#casegensub').parsley().on('field:validated', function() {
		  ...
		  .on('form:submit', function() {
			 // alert("coming here");
			  ...
			  document.forms.casegensub.action="../web/addCaseGenSub";
				 document.forms.casegensub.submit(); 
