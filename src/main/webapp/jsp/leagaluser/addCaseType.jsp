...
$('#adgwefryewry').click(function() {
	...
	/* 
	function loadaddcasetypeform(){
		
		alert("kal is here")
		
		  $('#casetype').attr('action', "../web/addCaseType");
          $("#casetype").submit();
	...
	<div class="page">
		...
		<div class="panel panel-primary ">
			<div class="panel-heading">
				<h3 class="panel-title">Add Case Type</h3>
			</div>
<form:form id="casetype" method="post" modelAttribute="casetype"  data-parsley-validate-if-empty="" >
			<div class='container'>
				...
				<div class="row col-md-12 toppad ">
						...
						<div class="col-md-3"></div>
						  <div class="col-md-6">
                             <div class="col-md-6">
							<label class="label-control rowlebel ">Case Type</label>
							</div>
							<div class="col-md-6"> <input
								type="text" class="form-control" 
								id="caseType" name="caseType" placeholder="Name"  required />
								</div>
								 ...
								 <label class="label-control rowlebel ">Select Court</label> 
								  ...
								  <div class="col-md-6">
								  <select
								class="form-control" id="courtId"  name="courtId"  required> 
					...
					<div class="row show-grid">
                       <div class="col-md-6">
							<label class="label-control rowlebel "></label><input
								...
								id="addcaseType" value="Add Case Type" onclick="loadaddcasetypeform()">
						</div>
						
						<div class="col-md-6">
							<label class="label-control rowlebel "></label><input type="Button" class="btn btn-1 btn-primary center-block"
...
$(function () {
	 $('#casetype').parsley().on('field:validated', function() {
		  ...
		  .on('form:submit', function() {
			 // alert("coming here");
			  ...
			  document.forms.casetype.action="../web/addCaseType";
				 document.forms.casetype.submit(); 
