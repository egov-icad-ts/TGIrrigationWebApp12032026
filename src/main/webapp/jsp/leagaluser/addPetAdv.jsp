...
$('#adgwefryewry').click(function() {
	...
	/* function loadaddpetadvform(){
		
		alert("kal is here")
		
		  $('#petAdv').attr('action', "../web/addPetAdv");
          $("#petAdv").submit();
	...
	<div class="page">
		...
		<div class="panel panel-primary ">
			<div class="panel-heading">
				<h3 class="panel-title">Add Petitioner Advocate</h3>
			</div>
<form:form id="petAdv" method="post" modelAttribute="petitionerAdv"  data-parsley-validate-if-empty="" >
			<div class='container'>
...
$(function () {
	 $('#petAdv').parsley().on('field:validated', function() {
		  ...
		  .on('form:submit', function() {
			 // alert("coming here");
			  ...
			  document.forms.petAdv.action="../web/addPetAdv";
				 document.forms.petAdv.submit(); 
