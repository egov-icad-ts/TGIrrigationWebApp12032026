...
function getcompmonayacut(componentId,unitId)
{
	...
	function deleteAyacutData(compAyacutId){
		
		
		// alert("klcoming here"+compPowerId);
		 $("#deleteFlag").val(true);
		  $("#compMonAyacutId").val(compAyacutId);
	...
	function editAyacutData(compMonAyacutId){
		 $("#editFlag").val(true);
		
		 var features="width=500,height=300,menubar=no,status=no,location=no,toolbar=no,scrollbars=yes,top=100,left=50";
	 	  	var url="../comptsimis/editCompMonAyacut?compMonAyacutId="+compMonAyacutId+"&editFlag="+false;
...
<form:form id="delCompMonAyacut" method="post"
				modelAttribute="delCompMonAyacut" >
				...
				<input name=compMonAyacutId  id="compMonAyacutId" type=hidden >
...
<c:forEach items="${unitData}" var="u">								
	...
	<a class="myunit"  href="../comptsimis/delCompMonAyacut?unitId=<c:out value="${u.unitId}"></c:out>" ><strong><c:out value="${u.unitName}"></c:out></strong></a>
	...
	<c:if test="${u.unitId==c.unitId}">
	  <input name=projectId    id="projectId"  type=hidden  value="<c:out value="${c.projectId}"></c:out>" />
		...
		<li><a class="mycircle"  onclick="getcompmonayacut(<c:out value="${c.projectId}"></c:out>)"  href="javascript:void(0);"><c:out value="${c.projectName}"></c:out></a>
	...
	<c:forEach items="${compsList}" var="d">
	 <c:if test="${c.projectId==d.projectId}"> 
	  <input name=componentId    id="componentId"  type=hidden  value="<c:out value="${d.componentId}"></c:out>" />
		...
		<li><a class="mycomps"  onclick="getcompmonayacut(<c:out value="${d.componentId}"></c:out>,<c:out value="${u.unitId}"></c:out>)"  href="javascript:void(0);"><c:out value="${d.componentName}"></c:out></a>
	...
	<div class="panel panel-primary  col-md-12">
			<div class="panel-heading">
				<h3 class="panel-title">Edit/Delete Component Ayacut</h3>
			</div>
		...
		<div class="col-md-2">
				<a href="../comptsimis/delCompMonAyacut">	<input type="button" class="btn btn-1 btn-primary center-block"
	...
	<!-- <div class="w3layouts_vertical_tab resp-tab-content resp-tab-content-active  col-md-8" style="display:block"> -->
		...
		<div class="col-md-2" style="color:blue">Unit:</div>
					...
					<c:out value="${cpayacut[0].unitName}"></c:out>
					</div>
					<div class="col-md-2" style="color:blue">Project:</div>
					<div class="col-md-2" style="color:red">
				
				<c:out value="${cpayacut[0].projectName}"></c:out>
				</div>
				<div class="col-md-2" style="color:blue">Component:</div>
				<div class="col-md-2" style="color:red">
				<c:out value="${cpayacut[0].componentName}"></c:out> 
				</div>
		...
		<br></br>
									...
									<div class="col-md-1">Constituency</div>
									
									<div class="col-md-1">District </div>
									<div class="col-md-2">Mandal </div>
									
									<div class="col-md-2">Village </div>
								
									<div class="col-md-1">Ayacut Contemplated</div>
									<div class="col-md-1">Stabilized Ayacut</div>
									<div class="col-md-1">Ayacut month</div>
								...
								<div class="col-md-12"  style="color: blue">
									...
									<c:forEach items="${cpayacut}" var="t" varStatus="count">
										...
										<div class="row show-grid" >
											...
											<div class="col-md-1"><c:out value="${t.constName}"></c:out> </div>
											<div class="col-md-1"><c:out value="${t.districtName}"></c:out> </div>
											<div class="col-md-2">  <c:out value="${t.mandalName}"></c:out> </div>
											<div class="col-md-2"> <c:out value="${t.villageName}"></c:out></div>
											
											
											<div class="col-md-1"><c:out value="${t.presentAyacutContemplated}"></c:out> </div> 	
											<div class="col-md-1"><c:out value="${t.presentAyacutCreated}"></c:out>  </div>
											
											<div class="col-md-1"><c:out value="${t.presentAyacutmonth}"></c:out> </div>
										
											
											
															
											<div class="col-md-2">  <button type="button" class="btn btn-primary btn-sm" onclick='editAyacutData(<c:out value="${t.compMonAyacutId}"></c:out>)' ><span class="glyphicon glyphicon-plus"></span></button>
											
							          <button type="button" class="btn btn-danger btn-sm" onclick='deleteAyacutData(<c:out value="${t.compMonAyacutId}"></c:out> )' ><span class="glyphicon glyphicon-remove"></span></button></div>
