...
<div class="w3_agile_main_left">
						...
						<div class="panel panel-primary ">
							...
							<form:form id="comppowerId" method="post" modelAttribute="comppowerbill" enctype="multipart/form-data"
									...
									<option value="${u.unitId}">${u.unitName}</option>
											...
											<div class="col-md-6">
												...
												<input type="text" class="form-control"
													...
													placeholder="number Ex:57267" required  data-parsley-type="alphanum"  />
											</div>
											...
											<div class="col-md-6">
												...
												<label class="label-control rowlebel ">Bill Date 
													...
													id="billDate" name="billDate" readonly="readonly"
													required value="0" />
											...
											<div class="col-md-6">
												...
												<label class="label-control rowlebel ">Bill Due Date 
													...
													<div class="col-md-6"> <input type="text" class="form-control  compareDate datepicker "
													id="billDueDate" name="billDueDate" readonly="readonly"
													required value="0" />
	...
	<div class="col-md-6">
												...
												<div class="col-md-6"> <input type="text" class="form-control"
													...
													placeholder="load in mW"  value="0"  data-parsley-type="number"   />
											</div>
												...
												<input type="text" class="form-control"
													...
													placeholder="KVAH" required   data-parsley-type="number"  />
											</div>
											...
											<div class="col-md-6">
												...
												<input type="text" class="form-control"
													...
													placeholder="5.80/KVAH" required   data-parsley-type="number"  />
											</div>
											...
											<div class="col-md-6">
												...
												<input type="text" class="form-control"
													...
													placeholder="0.06/KVAH" required  data-parsley-type="number"   />
											</div>
												...
												<input type="text" class="form-control variable"
													...
													placeholder="Rs:2637267.67" required  data-parsley-type="number"   value="0"  />
											</div>
											...
											<div class="col-md-6">
												...
												<div class="col-md-6"> <input type="text" class="form-control total"
													id="variableCharges" name="variableCharges"
											...
											<div class="col-sm-6">
											  ...
											  <br></br>
												...
												<input type="text" class="form-control"
													...
													placeholder="165/KVA" required    data-parsley-type="number"  />
											</div>
												...
												<input type="text" class="form-control fixed"
													id="demandCharges" name="demandCharges"  value="0" data-parsley-type="number" 
													 />
											</div>
												...
												<input type="text" class="form-control fixed"
													...
													placeholder="Rs. 67357.67" required  value="0"  data-parsley-type="number"  />
											</div>
											<div class="col-md-6">
												...
												<input type="text" class="form-control"
													...
													placeholder="5ps/Rs.100"   data-parsley-type="integer"  />
											</div>
											<div class="col-md-1">
											(OR)
											</div>
											...
											<div class="col-md-6">
												...
												<input type="text" class="form-control"
													...
													placeholder="150/Day"   data-parsley-type="integer"  />
											</div>
											...
											<label class="label-control rowlebel ">(D)ACD Surcharges </label> 
												...
												<input type="text" class="form-control total"
													id="ACDSurCharges" name="ACDSurCharges"
											...
											<div class="col-md-6">
												...
												<div class="col-md-6"> <input type="text" class="form-control"
													id="liftMetres" name="liftMetres"
													 required value="0"  data-parsley-type="number" />
											</div>
...
<script type="text/javascript" class="example">
	$(function() {
		...
		.on('form:submit', function() {
			...
			document.forms.comppowerId.action = "../comptsimis/ComponentPowerBill";
