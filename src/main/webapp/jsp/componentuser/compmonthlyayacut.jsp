...
<div class="w3_agile_main_left">
					...
					<div class="panel panel-primary ">
							<div class="panel-heading">
								<h3 class="panel-title">Component Ayacut Created</h3>
							</div>
							<form:form id="compmonthly" method="post" modelAttribute="compayacut"
										...
										<div class="row show-grid">	
											<div class="col-md-6">
												...
												<input type="text" class="form-control"
													id="presentAyacutContemplated" name="presentAyacutContemplated"
											...
											<div class="col-md-6">
												...
												<label class="label-control rowlebel ">Ayacut Created Month/Date
													...
													id="presentAyacutmonth" name="presentAyacutmonth" readonly="readonly"
													required value="0" />
...
<script type="text/javascript" class="example">
	$(function() {
		...
		.on('form:submit', function() {
			...
			document.forms.compmonthly.action = "../comptsimis/compmonthlyayacut";
