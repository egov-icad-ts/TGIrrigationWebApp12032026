...
public class ComponentPackageStructureCoordinates {
	...
	private static List<LineSegment> drawLegend() {
		 ...
		 * 
		 * segment.setTextXcord("50"); segment.setTextYcord("675");
		...
		/*
		 * ig2.setColor(Color.black); ig2.draw3DRect(680, 660, 15, 15, false);
		 * ig2.setColor(Color.red); ig2.fillRect(680, 660, 15, 15);
		 * ig2.drawString("--", 700, 675); ig2.drawString("Court Cases", 720,
		 * 675);
		 */
		...
		/*
		 * ig2.setColor(Color.black); ig2.draw3DRect(260, 700, 15, 15, true);
		 * ig2.setColor(Color.orange); ig2.fillRect(260, 700, 15, 15);
		 * ig2.drawString("--", 280, 715); ig2.drawString("LA Component", 300,
		 * 715);
		 */
	...
	private static List<LineSegment> drawLine(LineSegment s) throws IllegalAccessException, InvocationTargetException {
		...
		System.out.println("coords classs ==== " + s.getFromKm());
		...
		if (params.length > 0) {
			...
			if (direction.equals("down")) {
				...
				for (int l = 0; l < params.length; l++) {
					...
					y1 = (y + (int) (Math
							.round((Double.parseDouble(String.valueOf(values[0].trim())) * 1000 * s.getScale()))));
					...
					segment.setChainageAt(Double.parseDouble(String.valueOf(values[0]))+Double.parseDouble(s.getFromKm()));
			...
			if (direction.equals("right")) {
				...
				for (int l = 0; l < params.length; l++) {
					...
					segment.setFlag(true);
					segment.setRemarks(values[3]);
					System.out.println("Double.parseDouble(s.getFromKm())"+Double.parseDouble(s.getFromKm()));
					segment.setChainageAt(Double.parseDouble(String.valueOf(values[0]))+Double.parseDouble(s.getFromKm()));
					segment.setStructureType(values[1]);
					if (String.valueOf(values[1].trim()).equals("1")) {
