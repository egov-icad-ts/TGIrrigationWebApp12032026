...
public class PDFCAGParaReply extends AbstractITextpdfPortraitView {
 ...
 String docname=" ";
		           ...
		           // System.out.println(m+"m"+e.PARAGRAPH);
		            ...
		            int c=listreplyData.size();
	 	        		...
	 	        		for(int d=0; d<c ; d++){
	 	        			 ...
	 	        			 // System.out.println("listparaData.get(a).getCagGistId"+listparaData.get(a).getCagGistId());
	 	        		 	 // System.out.println("listreplyData.get(d).getCagGistId()"+listreplyData.get(d).getCagGistId());
		  	 // System.out.println("main"+listparaData.get(a).getCagParaId());
		  	 // System.out.println("reply"+listreplyData.get(d).getCagParaId()+"--"+listreplyData.get(d).getCreateReplybyUnit());
		  	  	 	        		
	 	        		
	 	        		if((listparaData.get(a).getCagParaId().equals(listreplyData.get(d).getCagParaId()))&& listreplyData.get(d).getCreateReplybyUnit()==9832 ){
	 	        		
	 	        			
	 	        			//System.out.println("i am in "+listreplyData.get(d).getCagParaId());
		        			
		        			if(listparaData.get(a).getPacincluded()=="YES"){	
			 	        		 cell.setPhrase(new Phrase("ACTION TAKEN STATUS", redFont));
			  		 	         table.addCell(cell);
			 	        		}else if(listparaData.get(a).getPacincluded()=="NO") {
	  		 	      ...
	  		 	      //  if listreplyData.get(d).getpacincl=true  action
	  		 	      //   if listreplyData.get(d).getpacincl=false explanatory
	  		 	         
	  		// System.out.println(listreplyData.get(d).getParaReplyId());
              ...
              if(listreplyData.get(d).getReplyRemarks()!=null ){
            	  ...
            	  if(listreplyData.get(d).getReplyRemarks().length()>2){
            		 // System.out.println("parareply"+listreplyData.get(d).getReplyRemarks().length()+"   "+listreplyData.get(d).getReplyRemarks());
