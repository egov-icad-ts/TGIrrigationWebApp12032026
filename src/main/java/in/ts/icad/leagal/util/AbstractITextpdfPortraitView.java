...
public abstract class AbstractITextpdfPortraitView   extends AbstractView {
	
	 PdfTemplate total;

		public AbstractITextpdfPortraitView() {
		...
		protected void renderMergedOutputModel(Map<String, Object> model,
			...
			// Build PDF document.
			document.open();
			document.setMargins(60,20,50,40);// left,right,top,bottom 80 , 20 , 50, 20
			document.newPage();
