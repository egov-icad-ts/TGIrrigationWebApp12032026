...
import com.itextpdf.text.Font;
	...
	public class pdfIRparasgistViewBuilder extends AbstractITextPdfView {
		    ...
		    protected void buildPdfDocument(Map<String, Object> model, Document doc,
				...
				listreplyData=(List<ReplyData>) model.get("allreplys");
	...
	/*        
		       ...
		       String docname=" ";
		         ...
		         int f=1;
	 	        		...
	 	        		//	System.out.println(listParas.get(m).getParaId()+"now listreplyData.get(d).getParaId()"+listreplyData.get(d).getParaId() );
	 	        		    if(listParas.get(m).getParaId().equals(listreplyData.get(d).getParaId()) ){
	 	        		//  System.out.println("i am here listreplyData.get(d).getParaId()"+listreplyData.get(d).getParaId() );
		  		 	       //"Date: "+listreplyData.get(d).getReplyDate()+  
	 	        		if(listreplyData.get(d).getReplyAction()!=null){	
	 	        		 cell.setPhrase(new Phrase( "      Reply No "+f+":-"      , redFont));
	  		 	         table.addCell(cell);
	 	      ...
	 	      //  System.out.println(listreplyData.get(d).getParaId()+"listreplyData.get(d).getReplyAction()"+listreplyData.get(d).getReplyAction());
