...
public class DateUtil {
	...
	public static Timestamp getSQLDateWithTimenew(String dateString) throws ParseException {
	...
	public static java.sql.Date getSQLDatecustom(String dateString) throws ParseException {
