...
public class PDFTankGeninf extends AbstractITextPdfView {
	@Override
    protected void buildPdfDocument(Map<String, Object> model, Document doc,
		...
		List<Tanks> resGeninfo = new ArrayList<Tanks>();
		...
		resGeninfo=(List<Tanks>) model.get("tankgeninfo");
		...
		Paragraph sideheading = new Paragraph(" ", blackPlane);		
		  ...
		  Chunk textUnderline = new Chunk("Guidelines for Safety Inspection of Dams                                                                                                                     "+resGeninfo.get(0).getFreqoperationName()+" "+resGeninfo.get(0).getYear());
   ...
   cell2.getVerticalAlignment();
	 		   	 	     ...
	 		   	 	     cell.setPhrase(new Phrase(resGeninfo.get(0).getTankName(), blackNFont));
		   	 	         table.addCell(cell);
...
table.addCell(cell);
cell.setPhrase(new Phrase(resinspectinfo.get(0).getInspectOfficeName(), blackNFont));
table.addCell(cell);
...
table.addCell(cell);
cell.setPhrase(new Phrase( resGeninfo.get(0).getLatdegree()+" \u00B0 "+resGeninfo.get(0).getLatminutes()+" \' "+resGeninfo.get(0).getLatseconds()+" \" ", blackNFont));
table.addCell(cell);
...
cell.setPhrase(new Phrase(" Longitude :", blackFont));
table.addCell(cell);
cell.setPhrase(new Phrase(resGeninfo.get(0).getLongdegree()+" \u00B0 "+resGeninfo.get(0).getLongminutes()+" \' "+resGeninfo.get(0).getLongseconds()+" \" ", blackNFont));
table.addCell(cell);
