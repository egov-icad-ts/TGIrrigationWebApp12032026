...
public class PDFTankInspectionInfo extends AbstractITextPdfView {
	@Override
    protected void buildPdfDocument(Map<String, Object> model, Document doc,
		...
		Paragraph title = new Paragraph( resinspectinfo.get(0).getInspectOfficeName() +"  Inspection Details of  "+resGeninfo.get(0).getTankName(), blacktitle);
   ...
   cell2.getVerticalAlignment();
	 		   	 	     ...
	 		   	 	     cell.setPhrase(new Phrase(resGeninfo.get(0).getTankName(), blackFont));
		   	 	         table.addCell(cell);
