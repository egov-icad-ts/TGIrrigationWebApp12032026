...
public interface LeagalAdminDAO {
...
List<District> getDistricts() throws  LeagalUserException;
	...
	List<Subdivision> getSubDivisionList(int divisionId) throws LeagalUserException;
	/*List<Subdivision> getSectionList(int subdivisionId)
...
public Integer editData(String query);
	...
	List<Map<String, Object>> generalqueryforresult(String generalquery);
...
List<User> logDetails(String userName) throws LeagalUserException;
